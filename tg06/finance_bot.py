...
keyboard = ReplyKeyboardMarkup(
    keyboard=[
        ...
        [KeyboardButton(text="Советы"), KeyboardButton(text="Финансы")]
    ],
...
async def exchange_rates(message: Message):
    url = "https://v6.exchangerate-api.com/v6/7b1cefb16f8760643389abff/latest/USD"
    try:
...
async def send_tips(message: Message):
    tips = [
        ...
        "Отключайте электроприборы когда не используете.",
...
async def finances_expenses3(message: Message, state: FSMContext):
    try:
        ...
        await message.answer(f"Сохранено. Всего: {total} руб.")
    except:
        await message.reply("Введите число:")
